...
export interface RobotSession {
  ...
  qty_typical: number;
  /**
   * Робота нашли по одному такту: бьёт ровно, а объём каждый раз новый. Границы
   * лотовки у такого — размах, в котором он гуляет, а не допуск на один размер.
   */
  ranged: boolean;
  ...
  active: boolean;
  /** Сколько тактов подряд робот промолчал. У живого всегда 0: пропустивший уходит в историю. */
  misses: number;
  /**
